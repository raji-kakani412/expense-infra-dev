resource "aws_cloudfront_distribution" "expense" {
  ...
  # this is dynamic content evaluated at last no cache
  ...
  viewer_certificate {
        acm_certificate_arn=local.https_acm_cert_arn
  ...
  records = [
    {
      ...
      alias = {
        ...
        zone_id=aws_cloudfront_distribution.expense.hosted_zone_id # this belongs to CDN internal hosted zone , not ours
      }
